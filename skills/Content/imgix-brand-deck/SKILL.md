...
## Related Skills
- **imgix-brand-voice** (global) — All deck content follows brand voice
- **Content/copywriting** — Slide copy may need copywriting support
- **Product-Marketing/sales-enablement** — Decks are a key sales enablement asset
- **Product-Marketing/launch-strategy** — Feature launch decks
- **Content/case-studies** — Case study data used in deck proof points
