...
## Related Skills
- **imgix-brand-voice** (global) — AEO content must follow brand voice
- **Discoverability/imgix-programmatic-seo** — Comparison and integration pages need AEO optimization
- **Discoverability/schema-markup** — Structured data implementation (30-40% AI visibility boost)
- **Discoverability/content-gaps** — Identifies what content to create; AEO defines how to structure it
- **Discoverability/competitive-intel** — Monitors how AI models describe competitors
- **Content/technical-writing** — Technical content structured for AI citation
- **Lifecycle/customer-advocacy** — Third-party mentions boost AI citations 6.5x
